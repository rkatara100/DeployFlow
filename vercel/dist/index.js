...
app.post("/deploy", (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const keys = files.map(file => file.slice(__dirname.length + 1).split(path_1.default.sep).join("/"));
    yield Promise.all(files.map((file, i) => {
        console.log("uploading", keys[i]);
        return (0, aws_1.uploadFile)(keys[i], file);
    }));
